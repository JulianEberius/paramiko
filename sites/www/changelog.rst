...
- :feature:`897` Implement 'canonical hostname' ``ssh_config`` functionality
  (``CanonicalizeHostname``, ``CanonicalDomains``,
  ``CanonicalizeFallbackLocal``, ``CanonicalizeMaxDots``, and
  ``CanonicalizePermittedCNAMEs``). All were previously silently ignored.
  Reported by Michael Leinartas.
